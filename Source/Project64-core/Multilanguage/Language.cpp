...
#define DEF_STR(ID,str) m_DefaultStrings.insert(LANG_STRINGS::value_type(ID,str))
    ...
    DEF_STR(MENU_SLOT_11, "Slot 11");
    DEF_STR(MENU_SLOT_12, "Slot 12");
    DEF_STR(MENU_SLOT_13, "Slot 13");
    DEF_STR(MENU_SLOT_14, "Slot 14");
    DEF_STR(MENU_SLOT_15, "Slot 15");
    DEF_STR(MENU_SLOT_16, "Slot 16");
    DEF_STR(MENU_SLOT_17, "Slot 17");
    DEF_STR(MENU_SLOT_18, "Slot 18");
    DEF_STR(MENU_SLOT_19, "Slot 19");
    DEF_STR(MENU_SLOT_20, "Slot 20");
    DEF_STR(MENU_SLOT_21, "Slot 21");
    DEF_STR(MENU_SLOT_22, "Slot 22");
    DEF_STR(MENU_SLOT_23, "Slot 23");
    DEF_STR(MENU_SLOT_24, "Slot 24");
    DEF_STR(MENU_SLOT_25, "Slot 25");
    DEF_STR(MENU_SLOT_26, "Slot 26");
    DEF_STR(MENU_SLOT_27, "Slot 27");
    DEF_STR(MENU_SLOT_28, "Slot 28");
    DEF_STR(MENU_SLOT_29, "Slot 29");
    DEF_STR(MENU_SLOT_30, "Slot 30");
    DEF_STR(MENU_SLOT_31, "Slot 31");
    DEF_STR(MENU_SLOT_32, "Slot 32");
    DEF_STR(MENU_SLOT_33, "Slot 33");
    DEF_STR(MENU_SLOT_34, "Slot 34");
    DEF_STR(MENU_SLOT_35, "Slot 35");
    DEF_STR(MENU_SLOT_36, "Slot 36");
    DEF_STR(MENU_SLOT_37, "Slot 37");
    DEF_STR(MENU_SLOT_38, "Slot 38");
    DEF_STR(MENU_SLOT_39, "Slot 39");
    DEF_STR(MENU_SLOT_40, "Slot 40");
    DEF_STR(MENU_SLOT_41, "Slot 41");
    DEF_STR(MENU_SLOT_42, "Slot 42");
    DEF_STR(MENU_SLOT_43, "Slot 43");
    DEF_STR(MENU_SLOT_44, "Slot 44");
    DEF_STR(MENU_SLOT_45, "Slot 45");
    DEF_STR(MENU_SLOT_46, "Slot 46");
    DEF_STR(MENU_SLOT_47, "Slot 47");
    DEF_STR(MENU_SLOT_48, "Slot 48");
    DEF_STR(MENU_SLOT_49, "Slot 49");
    DEF_STR(MENU_SLOT_50, "Slot 50");
    DEF_STR(MENU_SLOT_51, "Slot 51");
    DEF_STR(MENU_SLOT_52, "Slot 52");
    DEF_STR(MENU_SLOT_53, "Slot 53");
    DEF_STR(MENU_SLOT_54, "Slot 54");
    DEF_STR(MENU_SLOT_55, "Slot 55");
    DEF_STR(MENU_SLOT_56, "Slot 56");
    DEF_STR(MENU_SLOT_57, "Slot 57");
    DEF_STR(MENU_SLOT_58, "Slot 58");
    DEF_STR(MENU_SLOT_59, "Slot 59");
    DEF_STR(MENU_SLOT_60, "Slot 60");
    DEF_STR(MENU_SLOT_61, "Slot 61");
    DEF_STR(MENU_SLOT_62, "Slot 62");
    DEF_STR(MENU_SLOT_63, "Slot 63");
    DEF_STR(MENU_SLOT_64, "Slot 64");
    DEF_STR(MENU_SLOT_65, "Slot 65");
    DEF_STR(MENU_SLOT_66, "Slot 66");
    DEF_STR(MENU_SLOT_67, "Slot 67");
    DEF_STR(MENU_SLOT_68, "Slot 68");
    DEF_STR(MENU_SLOT_69, "Slot 69");
    DEF_STR(MENU_SLOT_70, "Slot 70");
    DEF_STR(MENU_SLOT_71, "Slot 71");
    DEF_STR(MENU_SLOT_72, "Slot 72");
    DEF_STR(MENU_SLOT_73, "Slot 73");
    DEF_STR(MENU_SLOT_74, "Slot 74");
    DEF_STR(MENU_SLOT_75, "Slot 75");
    DEF_STR(MENU_SLOT_76, "Slot 76");
    DEF_STR(MENU_SLOT_77, "Slot 77");
    DEF_STR(MENU_SLOT_78, "Slot 78");
    DEF_STR(MENU_SLOT_79, "Slot 79");
    DEF_STR(MENU_SLOT_80, "Slot 80");
    DEF_STR(MENU_SLOT_81, "Slot 81");
    DEF_STR(MENU_SLOT_82, "Slot 82");
    DEF_STR(MENU_SLOT_83, "Slot 83");
    DEF_STR(MENU_SLOT_84, "Slot 84");
    DEF_STR(MENU_SLOT_85, "Slot 85");
    DEF_STR(MENU_SLOT_86, "Slot 86");
    DEF_STR(MENU_SLOT_87, "Slot 87");
    DEF_STR(MENU_SLOT_88, "Slot 88");
    DEF_STR(MENU_SLOT_89, "Slot 89");
    DEF_STR(MENU_SLOT_90, "Slot 90");
    DEF_STR(MENU_SLOT_91, "Slot 91");
    DEF_STR(MENU_SLOT_92, "Slot 92");
    DEF_STR(MENU_SLOT_93, "Slot 93");
    DEF_STR(MENU_SLOT_94, "Slot 94");
    DEF_STR(MENU_SLOT_95, "Slot 95");
    DEF_STR(MENU_SLOT_96, "Slot 96");
    DEF_STR(MENU_SLOT_97, "Slot 97");
    DEF_STR(MENU_SLOT_98, "Slot 98");
    DEF_STR(MENU_SLOT_99, "Slot 99");
    ...
    DEF_STR(SAVE_SLOT_11, "Save Slot - 11");
    DEF_STR(SAVE_SLOT_12, "Save Slot - 12");
    DEF_STR(SAVE_SLOT_13, "Save Slot - 13");
    DEF_STR(SAVE_SLOT_14, "Save Slot - 14");
    DEF_STR(SAVE_SLOT_15, "Save Slot - 15");
    DEF_STR(SAVE_SLOT_16, "Save Slot - 16");
    DEF_STR(SAVE_SLOT_17, "Save Slot - 17");
    DEF_STR(SAVE_SLOT_18, "Save Slot - 18");
    DEF_STR(SAVE_SLOT_19, "Save Slot - 19");
    DEF_STR(SAVE_SLOT_20, "Save Slot - 20");
    DEF_STR(SAVE_SLOT_21, "Save Slot - 21");
    DEF_STR(SAVE_SLOT_22, "Save Slot - 22");
    DEF_STR(SAVE_SLOT_23, "Save Slot - 23");
    DEF_STR(SAVE_SLOT_24, "Save Slot - 24");
    DEF_STR(SAVE_SLOT_25, "Save Slot - 25");
    DEF_STR(SAVE_SLOT_26, "Save Slot - 26");
    DEF_STR(SAVE_SLOT_27, "Save Slot - 27");
    DEF_STR(SAVE_SLOT_28, "Save Slot - 28");
    DEF_STR(SAVE_SLOT_29, "Save Slot - 29");
    DEF_STR(SAVE_SLOT_30, "Save Slot - 30");
    DEF_STR(SAVE_SLOT_31, "Save Slot - 31");
    DEF_STR(SAVE_SLOT_32, "Save Slot - 32");
    DEF_STR(SAVE_SLOT_33, "Save Slot - 33");
    DEF_STR(SAVE_SLOT_34, "Save Slot - 34");
    DEF_STR(SAVE_SLOT_35, "Save Slot - 35");
    DEF_STR(SAVE_SLOT_36, "Save Slot - 36");
    DEF_STR(SAVE_SLOT_37, "Save Slot - 37");
    DEF_STR(SAVE_SLOT_38, "Save Slot - 38");
    DEF_STR(SAVE_SLOT_39, "Save Slot - 39");
    DEF_STR(SAVE_SLOT_40, "Save Slot - 40");
    DEF_STR(SAVE_SLOT_41, "Save Slot - 41");
    DEF_STR(SAVE_SLOT_42, "Save Slot - 42");
    DEF_STR(SAVE_SLOT_43, "Save Slot - 43");
    DEF_STR(SAVE_SLOT_44, "Save Slot - 44");
    DEF_STR(SAVE_SLOT_45, "Save Slot - 45");
    DEF_STR(SAVE_SLOT_46, "Save Slot - 46");
    DEF_STR(SAVE_SLOT_47, "Save Slot - 47");
    DEF_STR(SAVE_SLOT_48, "Save Slot - 48");
    DEF_STR(SAVE_SLOT_49, "Save Slot - 49");
    DEF_STR(SAVE_SLOT_50, "Save Slot - 50");
    DEF_STR(SAVE_SLOT_51, "Save Slot - 51");
    DEF_STR(SAVE_SLOT_52, "Save Slot - 52");
    DEF_STR(SAVE_SLOT_53, "Save Slot - 53");
    DEF_STR(SAVE_SLOT_54, "Save Slot - 54");
    DEF_STR(SAVE_SLOT_55, "Save Slot - 55");
    DEF_STR(SAVE_SLOT_56, "Save Slot - 56");
    DEF_STR(SAVE_SLOT_57, "Save Slot - 57");
    DEF_STR(SAVE_SLOT_58, "Save Slot - 58");
    DEF_STR(SAVE_SLOT_59, "Save Slot - 59");
    DEF_STR(SAVE_SLOT_60, "Save Slot - 60");
    DEF_STR(SAVE_SLOT_61, "Save Slot - 61");
    DEF_STR(SAVE_SLOT_62, "Save Slot - 62");
    DEF_STR(SAVE_SLOT_63, "Save Slot - 63");
    DEF_STR(SAVE_SLOT_64, "Save Slot - 64");
    DEF_STR(SAVE_SLOT_65, "Save Slot - 65");
    DEF_STR(SAVE_SLOT_66, "Save Slot - 66");
    DEF_STR(SAVE_SLOT_67, "Save Slot - 67");
    DEF_STR(SAVE_SLOT_68, "Save Slot - 68");
    DEF_STR(SAVE_SLOT_69, "Save Slot - 69");
    DEF_STR(SAVE_SLOT_70, "Save Slot - 70");
    DEF_STR(SAVE_SLOT_71, "Save Slot - 71");
    DEF_STR(SAVE_SLOT_72, "Save Slot - 72");
    DEF_STR(SAVE_SLOT_73, "Save Slot - 73");
    DEF_STR(SAVE_SLOT_74, "Save Slot - 74");
    DEF_STR(SAVE_SLOT_75, "Save Slot - 75");
    DEF_STR(SAVE_SLOT_76, "Save Slot - 76");
    DEF_STR(SAVE_SLOT_77, "Save Slot - 77");
    DEF_STR(SAVE_SLOT_78, "Save Slot - 78");
    DEF_STR(SAVE_SLOT_79, "Save Slot - 79");
    DEF_STR(SAVE_SLOT_80, "Save Slot - 80");
    DEF_STR(SAVE_SLOT_81, "Save Slot - 81");
    DEF_STR(SAVE_SLOT_82, "Save Slot - 82");
    DEF_STR(SAVE_SLOT_83, "Save Slot - 83");
    DEF_STR(SAVE_SLOT_84, "Save Slot - 84");
    DEF_STR(SAVE_SLOT_85, "Save Slot - 85");
    DEF_STR(SAVE_SLOT_86, "Save Slot - 86");
    DEF_STR(SAVE_SLOT_87, "Save Slot - 87");
    DEF_STR(SAVE_SLOT_88, "Save Slot - 88");
    DEF_STR(SAVE_SLOT_89, "Save Slot - 89");
    DEF_STR(SAVE_SLOT_90, "Save Slot - 90");
    DEF_STR(SAVE_SLOT_91, "Save Slot - 91");
    DEF_STR(SAVE_SLOT_92, "Save Slot - 92");
    DEF_STR(SAVE_SLOT_93, "Save Slot - 93");
    DEF_STR(SAVE_SLOT_94, "Save Slot - 94");
    DEF_STR(SAVE_SLOT_95, "Save Slot - 95");
    DEF_STR(SAVE_SLOT_96, "Save Slot - 96");
    DEF_STR(SAVE_SLOT_97, "Save Slot - 97");
    DEF_STR(SAVE_SLOT_98, "Save Slot - 98");
    DEF_STR(SAVE_SLOT_99, "Save Slot - 99");
